...
function renderPageToCanvas(
  ...
  if (isDesktop) {
    ...
    // Font size for title; Y positions derived proportionally
    const isXL = w >= 1280;
    const fontSize = isXL ? 38 : 19;
    const lineHeight = fontSize * 1.1;
    const maxInY = centerY - lineHeight * 0.3;
    const progressY = maxInY + lineHeight;
    const tickerY = progressY + fontSize * 0.5;
